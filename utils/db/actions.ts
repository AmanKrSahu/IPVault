...
import { Deployments, Users, Webpages } from "./schema";
import { create } from "@web3-storage/w3up-client";
import { ethers } from "ethers";
import WebpageStorageABI from "@/utils/db/WebpageStorage.json";
...
export async function initializeClients(userEmail: string) {
  ...
  contract = new ethers.Contract(
    "0xfD893D695D0b0A76042e6a41075d413e71BCAa1c",
...
async function updateNameContent(
  ...
  try {
    ...
    console.error("No existing revision", error);
